/**
 * Tool registry for Uganda Law MCP Server.
...
import { getUgandanImplementations, type GetUgandanImplementationsInput } from './get-ugandan-implementations.js';
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'including Uganda Law (National Council for Law Reporting). ' +
    ...
    'Call this FIRST when you need to understand what Ugandan legal data this server covers.',
  inputSchema: { type: 'object', properties: {} },
};
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Ugandan statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (section/article) from a Ugandan statute. ' +
  ...
  },
  {
    ...
    description:
      'Validate a Ugandan legal citation against the database — zero-hallucination check. ' +
      ...
      'Supports formats: "Section 25, Data Protection Act 2019", "s 25, DPA 2019", "Article 31, Constitution of Uganda 2010".',
    inputSchema: {
      type: 'object',
      properties: {
        citation: {
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Ugandan statutes simultaneously. ' +
      'Returns aggregated results from multiple relevant provisions, useful for legal research on a topic. ' +
      'Use this for broad legal questions like "What are the penalties for data breaches in Uganda?" ' +
  ...
  },
  {
    ...
    description:
      'Format a Ugandan legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether a Ugandan statute or provision is currently in force, amended, repealed, partially suspended, or not yet in force. ' +
  ...
  },
  {
    name: 'get_eu_basis',
    description:
      'Get the EU/international legal basis that a Ugandan statute aligns with or references. ' +
      'Uganda is not an EU member but several Ugandan laws were influenced by EU regulations ' +
    ...
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Ugandan statute identifier.' },
        include_articles: {
          type: 'boolean',
  ...
  {
    name: 'get_ugandan_implementations',
    description:
      'Find all Ugandan statutes that align with or implement a specific EU directive or regulation. ' +
      'Given an EU document ID (e.g., "regulation:2016/679" for GDPR), returns matching Ugandan statutes. ' +
      'Note: Uganda implements international standards through domestic legislation influenced by international frameworks.',
    inputSchema: {
      type: 'object',
      properties: {
        eu_document_id: {
  ...
  },
  {
    ...
    description:
      'Search for EU directives and regulations that have Ugandan implementing/aligning legislation. ' +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        has_ugandan_implementation: {
          type: 'boolean',
          description: 'If true, only return EU documents with Ugandan aligning legislation.',
        },
  ...
  },
  {
    ...
    description:
      'Get the EU/international legal basis for a SPECIFIC provision within a Ugandan statute. ' +
  ...
  },
  {
    ...
    description:
      'Check EU/international alignment status for a Ugandan statute or provision. ' +
    ...
    try {
      ...
      switch (name) {
        ...
        case 'get_eu_basis':
          ...
          break;
        case 'get_ugandan_implementations':
          result = await getUgandanImplementations(db, args as unknown as GetUgandanImplementationsInput);
          break;
