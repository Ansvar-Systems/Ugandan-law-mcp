...
**The Uganda Law alternative for the AI age.**

[![npm version](https://badge.fury.io/js/%40ansvar/uganda-law-mcp.svg)](https://www.npmjs.com/package/@ansvar/uganda-law-mcp)
[![MCP Registry](https://img.shields.io/badge/MCP-Registry-blue)](https://registry.modelcontextprotocol.io)
[![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![GitHub stars](https://img.shields.io/github/stars/Ansvar-Systems/Uganda-law-mcp?style=social)](https://github.com/Ansvar-Systems/Uganda-law-mcp)
[![CI](https://github.com/Ansvar-Systems/Uganda-law-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/Ansvar-Systems/Uganda-law-mcp/actions/workflows/ci.yml)
...
Query **494 Ugandan Acts** -- from the Data Protection Act and Computer Misuse and Cybercrimes Act to the Companies Act, Constitution of Uganda, and more -- directly from Claude, Cursor, or any MCP-compatible client.
...
Ugandan legal research is scattered across Uganda Law Reports, the Uganda Gazette, and various government portals. Whether you're:
- A **lawyer** validating citations in a brief or contract under Ugandan law
- A **compliance officer** checking if the Data Protection Act 2019 provisions apply to your processing activities
- A **legal tech developer** building tools on Ugandan legislation
...
**Endpoint:** `https://uganda-law-mcp.vercel.app/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add uganda-law --transport http https://uganda-law-mcp.vercel.app/mcp` |
...
```json
{
  "mcpServers": {
    "uganda-law": {
      "type": "url",
      "url": "https://uganda-law-mcp.vercel.app/mcp"
    }
  }
}
```
...
- *"What does the Constitution of Uganda say about the right to privacy?"*
- *"Search for data breach notification requirements in Ugandan law"*
- *"What are the obligations under the National Payment Systems Act?"*
- *"Validate this legal citation"*
- *"Build a legal stance on personal data processing in Uganda"*
...
| **Uganda Information and Communications Act** | 1998 (amended) | Regulates telecommunications and ICT sector; establishes the Communications Authority of Uganda |
...
| **Constitution of Uganda** | 2010 | Supreme law; Article 31 guarantees the right to privacy |
...
**Estimated database size:** ~80-150 MB (full corpus of Ugandan federal legislation)
...
| `format_citation` | Format citations per Ugandan conventions (full/short/pinpoint) |
...
| Tool | Description |
|------|-------------|
| `get_eu_basis` | Get EU directives/regulations for Ugandan statute |
| `get_ugandan_implementations` | Find Ugandan laws implementing EU act |
| `search_eu_implementations` | Search EU documents with Ugandan implementation counts |
...
- All statute text is ingested from official Ugandan government sources
...
- **[Uganda Law Reports](https://ugandalaw.org)** -- Official Ugandan government legal database
...
>
> Statute text is sourced from official Ugandan government publications. However:
...
```bash
git clone https://github.com/Ansvar-Systems/Uganda-law-mcp
cd Uganda-law-mcp
npm install
npm run build
npm test
...
**30+ national law MCPs** covering Australia, Brazil, Canada, China, Denmark, Finland, France, Germany, Ghana, Iceland, India, Ireland, Israel, Italy, Japan, Uganda, Netherlands, Nigeria, Norway, Singapore, Slovenia, South Korea, Sweden, Switzerland, Thailand, UAE, UK, and more.
...
```bibtex
@software{uganda_law_mcp_2025,
  author = {Ansvar Systems AB},
  title = {Ugandan Law MCP Server: AI-Powered Legal Research Tool},
  year = {2025},
  url = {https://github.com/Ansvar-Systems/Uganda-law-mcp},
  note = {Ugandan legal database with full-text search and EU cross-references}
}
```
...
- **Statutes & Legislation:** Ugandan Government (public domain)
