#!/usr/bin/env tsx
/**
 * Uganda Law MCP -- Census Script (AfricanLII Direct Scraping)
 *
 * Scrapes the legislation listing pages from ulii.org to enumerate
 * ALL acts. Writes data/census.json in golden standard format.
 *
 * No API key required -- scrapes the public listing pages directly.
 *
 * Source: https://ulii.org/en/legislation/
 *
 * Usage:
...
const JURISDICTION = 'UG';
const JURISDICTION_NAME = 'Uganda';
const PORTAL = 'https://ulii.org';
const LISTING_BASE = 'https://ulii.org/en/legislation/';
const AKN_PATH_PREFIX = '/en/akn/ug/';
