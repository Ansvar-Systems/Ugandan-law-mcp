#!/usr/bin/env tsx
/**
 * Uganda Law MCP -- Census Script (Laws.Africa API)
 *
 * Enumerates ALL acts for Uganda from the Laws.Africa Content API
 ...
 * E.g. "/akn/ug/act/2019/1" -> "ug-act-2019-1"
 */
