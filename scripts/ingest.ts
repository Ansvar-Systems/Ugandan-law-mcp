#!/usr/bin/env tsx
/**
 * Uganda Law MCP -- Census-Driven Ingestion Pipeline (AfricanLII Scraping)
 *
 * Reads data/census.json (produced by census.ts via AfricanLII scraping)
 * and fetches + parses every ingestable Act directly from ulii.org.
 *
 * Features:
 ...
 *
 * Data source: ulii.org (AfricanLII / Laws.Africa Peachjam platform)
...
const SOURCE_LABEL = 'ulii.org (AfricanLII direct scraping)';
